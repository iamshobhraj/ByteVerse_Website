  ...
  return (
    <main className="pt-6 flex flex-col items-center justify-center w-full mx-0">
      ...
      <div className="m-2 flex flex-col md:flex-row p-2 justify-evenly w-full gap-12 lg:pt-6 md:px-10 lg:px-36">
        <div className="md:w-5/12 bg-[#70363666] rounded-2xl px-3 py-4 text-sm md:px-5 md:py-6 lg:px-10 lg:py-8 lg:text-2xl shadow-lg shadow-[#8484843c] text-opacity-90 font-thin text-slate-100 h-40 md:h-64 lg:h-96 w-full mx-auto overflow-y-auto hide-scroll overflow-x-hidden flex flex-col justify-start items-center">
          <h2 className="font-bold p-2">
            ByteVerse 6.0: Forging the Odyssey of Development{" "}
          </h2>
          <p>
            {" "}
            Prepare to immerse yourself in 36 hours of unparalleled coding
            ...
            ignite your programming genius. Join us in cultivating an
            environment where programmers unite to tackle challenges head-on,
            pushing the boundaries of technology and innovation. Together, we'll
            embark on a journey to uncover optimal solutions using the latest
            technologies, all while racing against the clock. ByteVerse 2.0
            isn't just a hackathon; it's a playground for inventive minds to
            collaborate, innovate, and redefine what's possible in the world of
            coding. Are you geared then to unleash your coding prowess and leave
            your mark on ByteVerse 2.0? Let's create something extraordinary
            together!
          </p>
        </div>
