  ...
  const tabs = [
    {
      ...
      value: "leads",
      content: (
        <div className="flex flex-col gap-6 items-center w-full overflow-hidden relative h-1/2 md:h-fit rounded-2xl py-6 text-xl md:text-4xl font-bold text-white shadow-xl bg-[#521414]">
          <p>Leads</p>
