...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      ans: <div><p>The Prize money for the winning teams: </p> <ul className="list-disc list-inside"><li>1st Prize: ₹10,000</li><li>2nd Prize: ₹8,000</li><li>3rd Prize: ₹6,000</li><li>Best All Girls Team: ₹5,000</li><li>Best 1st Year Team: ₹3,000</li></ul></div>,
    },
    {
      id: 2,
    ...
    {
      id: 4,
      query: "Are there additional perks and subscriptions for the winning team?",
  ...
  return (
    ...
    >
      ...
      <div className="z-10 w-full h-auto flex flex-col md:flex-row justify-evenly items-center md:p-48 p-6">
        <div className="w-full p-4  md:w-[600px]  flex flex-col justify-center items-start mb-6 md:mb-0 text-[#DEB889]  ">
        ...
        <div className="p-4 sm:w-full md:w-[400px] rounded-lg">
          {faqs.map((faq) => (
            <Accordion key={faq.id} title={faq.query} answer={faq.ans} expanded={expandedAccordion === faq.id} onToggle={() => toggleAccordion(faq.id)} />
          ))}
        </div>
      </div>
    </div>
